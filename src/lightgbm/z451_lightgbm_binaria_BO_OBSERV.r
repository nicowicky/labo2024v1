...
PARAM$trainingstrategy$undersampling <- 1.0           # no se aplica submuestreo.
PARAM$hyperparametertuning$iteraciones <- 120         # de iteraciones, mas iteraciones, mas ehasutivo el analisis.
PARAM$hyperparametertuning$xval_folds <- 5            # numero de folds, para validacion cruzada.
